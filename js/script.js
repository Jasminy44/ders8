const ceviri = {
    tr: {
        texts:{
            ...
            name:"Kurs tarafindan yeniden kodlandi",
            name2:"Kurs tarafindan yeniden kodlandi",
          ...
          labels:{
            ...
            fireplace:"sömine",
            forest:"orman",
            heavyRain:"Yogun Yagmur",
            nightCrickets:"Circir Böcekleri",
            rain:"Yagmur",
            rainCamping:"yagmur,kamp",
            rainWindshiled:"Yagmur,ön cam",
            snow:"Kar",
    ...
    en: {
        texts:{
            ...
            contents: "What technologies were used?",
            aboutApp: "About App",
            name: "Created by Milyaz Kamil",
            name2: "Created by Milyaz Kamil",
            rights: "©️ All Rights Reserved"
        },    
        labels :{
            beach:"Beach",
            birds:"Birds",
...
dilButonlari.forEach(buton =>{
    ...
    buton.addEventListener("click", (e) => {
        let tiklananButton =e.currentTarget
        let dil =null
        if(tiklananButton.classList.contains("turkish-button")===true){
            dil = "tr"
        }else{
            dil = "en"
        }
        ...
        document.querySelector(".heavy-rain-p").innerText = ceviri.labels.heavyRain;
